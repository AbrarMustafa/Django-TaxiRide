from .api.serializers import RiderProfileSerializer, SavedAddressSerializer
from rest_framework import generics, status, permissions
from rest_framework.response import Response
from .models import RiderProfile, SavedAddress
...
class ListRiderAdresses(generics.ListAPIView):
    ...
    def get_queryset(self):
        queryset = SavedAddress.objects.filter(rider=self.request.user.rider_profile)
        return queryset
